...
# Filtering thresholds (updated from parameter sweep to reduce false positives).
# Best-found conservative config: tighter circularity and extent to lower FP,
# while later a conservative fallback will attempt to recover small misses.
